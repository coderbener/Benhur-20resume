    ...
    <section id="experience" className="py-24 px-4 sm:px-6 lg:px-8 relative"
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="space-y-8 relative">
          {/* Timeline line */}
          <div className="absolute left-6 top-0 bottom-0 w-1" style={{ background: "linear-gradient(180deg, rgba(239, 68, 68, 0.6), rgba(239, 68, 68, 0.2))" }}></div>
          ...
          {experiences.map((exp, index) => (
            ...
            >
              {/* Timeline dot */}
              <div className="absolute -left-4 top-2 w-6 h-6 bg-red-500 rounded-full border-4 transition-all hover:shadow-lg hover:scale-110"
                   style={{ borderColor: "#141414", boxShadow: "0 0 12px rgba(239, 68, 68, 0.3)" }}></div>

              {/* Content */}
              <div className="rounded-lg p-8 transition-all duration-300 hover:-translate-y-1"
                   style={{ borderColor: "rgba(239, 68, 68, 0.3)", background: "rgba(20, 20, 20, 0.5)", border: "1px solid rgba(239, 68, 68, 0.3)" }}
                   onMouseEnter={(e) => {
                ...
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-4">
                  <div className="flex-grow">
                    ...
                    <p className="text-red-400 font-sans font-semibold text-base mt-2">
                      {exp.company}
                    </p>
                  ...
                  <div className="text-right">
                    <p className="text-red-400 font-sans font-semibold text-base whitespace-nowrap">
                      {exp.period}
                    </p>
                  </div>
                </div>
                ...
                <ul className="space-y-3 mt-6">
                  {exp.achievements.map((achievement, index) => (
                    ...
                    >
                      <span className="text-red-500 mt-1.5 flex-shrink-0 font-bold">→</span>
