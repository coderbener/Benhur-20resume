            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full bg-slate-800/50 border border-emerald-500/30 text-white placeholder-gray-400 font-sans text-base px-4 py-3 rounded-lg focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 transition-all duration-300"
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-emerald-500 to-emerald-600 text-white hover:shadow-lg hover:shadow-emerald-500/50 disabled:opacity-50 py-3 sm:py-4 rounded-lg transition-all duration-300 font-sans font-semibold text-base hover:scale-105"
              >
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a
                  ...
                  className="w-12 h-12 bg-emerald-500/10 border border-emerald-500/30 hover:border-emerald-500/60 rounded-lg flex items-center justify-center text-emerald-400 hover:text-emerald-300 transition-all"
                  title="LinkedIn"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 bg-amber-500/10 border border-amber-500/30 hover:border-amber-500/60 rounded-lg flex items-center justify-center text-amber-400 hover:text-amber-300 transition-all"
                  title="GitHub"
                >
              ...
              <div className="mt-8">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-block px-5 py-2 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white hover:shadow-lg hover:shadow-emerald-500/50 rounded-lg transition-all font-sans text-sm font-medium hover:scale-105"
                >
                  TryHackMe Profile
                </a>
              </div>
